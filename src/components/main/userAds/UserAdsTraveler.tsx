...
const AdsPreview = () => {
  ...
  return (
    ...
    >
      <p className="text-[12px] mb-5 text-red-500">Annonce non validée</p>
      <Label htmlFor="name" labelText="Nom du voyageur" value={datas?.nom} />
      <Label htmlFor="villeDepart" labelText="Ville de départ" value={datas?.villeDepartDoc?.name} />
      <Label htmlFor="dateDepart" labelText="Date de départ" value={datas.dateDepart} />
      <Label htmlFor="villeArrivee" labelText="Ville d'arrivée" value={datas?.villeArriveDoc?.name} />
      <Label htmlFor="dateArrivee" labelText="Date d'arrivée" value={datas.dateArrivee} />
